class Carta extends Phaser.Sprite {
	constructor(game, x, y, frontside, backside, yflip = false) {
		...
		this.highlight = this.game.add.sprite(0, 0, "carta_highlight");
		...
		// Shadow
		this.shadow = this.game.add.sprite(0, 0, 'carta_shadow');
		...
		this.events.onInputDown.add(function () { this.clicked.dispatch(this); }, this);
	}
	...
	unsetFlippable() {
		this.setHovering(0);
		this.highlight.alpha = 0.0;
		// this.events.onInputDown.remove(this.flip, this);
